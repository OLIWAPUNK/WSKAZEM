@tool
class_name InterpretationMaker
extends EditorPlugin


const editor_scene_template = preload("res://addons/InterpretationMaker/StateTreeGraph.tscn")
...
func _get_plugin_icon():
	return EditorInterface.get_editor_theme().get_icon("AcceptDialog", "EditorIcons")
